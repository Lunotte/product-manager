...
Que faire si categorie (ou autre) n’existe pas ? Erreur + inviter à corriger le fichier d’import ? (Ce qui est actuellement réalisé)
Est-il possible de me fournir la dernière version de la bdd ?
